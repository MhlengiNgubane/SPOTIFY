...
function Center() {
  ...
  return ( 
    <div className="flex-grow h-screen overflow-y-scroll scrollba">
        <header className="absolute top-5 right-8">
            <div className="flex text-white items-center bg-black space-x-3
        ...
        to-black from-blue-500 h-80 text-white p-8">
